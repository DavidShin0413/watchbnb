...
review1 = Review.create(comment: dummy_text, rating: 5, watch_id: rolex.id)
review2 = Review.create(comment: dummy_text, rating: 4, watch_id: rolex.id)
review3 = Review.create(comment: dummy_text, rating: 3, watch_id: rolex.id)
review4 = Review.create(comment: dummy_text, rating: 2, watch_id: rolex.id)
review5 = Review.create(comment: dummy_text, rating: 1, watch_id: rolex.id)
