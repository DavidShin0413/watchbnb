...
pp = Watch.create(user_id: bob.id, name: "Patek Phillippe", style: "Dress", location: "Swiss", price: 100, img_url: "https://www.tissotwatches.com/media/catalog/product/cache/aaadd316e453df5b08f7f4246fad1a9c/T/1/T137.407.11.041.00_R.png")
tissot = Watch.create(user_id: bob.id, name: "Tissot", style: "Dress", location: "Swiss", price: 100, img_url: "https://www.tissotwatches.com/media/catalog/product/cache/aaadd316e453df5b08f7f4246fad1a9c/T/1/T116.617.11.057.01_R_1.png")
tissot_2 = Watch.create(user_id: bob.id, name: "Tissot T Touch", style: "Dress", location: "Swiss", price: 100, img_url: "https://www.tissotwatches.com/media/catalog/product/cache/aaadd316e453df5b08f7f4246fad1a9c/T/1/T121.420.44.051.00_R_1.png")
...
seed4 = Review.create(comment: "The watch does not seem to work properly.", rating: 2, watch_id: omega.id)
